...
var require_util = __commonJS({
  "node_modules/blakejs/util.js"(exports, module) {
    ...
    function testSpeed(hashFn, N5, M4) {
      ...
      for (let i3 = 0; i3 < M4; i3++) {
        ...
        console.log(
          Math.round(N5 / (1 << 20) / (ms2 / 1e3) * 100) / 100 + " MB PER SECOND"
        );
      }
    }
    module.exports = {
...
var require_blake2b = __commonJS({
  "node_modules/blakejs/blake2b.js"(exports, module) {
    ...
    function B2B_G(a2, b3, c4, d2, ix, iy) {
      const x0 = m2[ix];
      const x1 = m2[ix + 1];
      const y0 = m2[iy];
      const y1 = m2[iy + 1];
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-OXRI3N3N.js");
  const signature_ = (() => {
...
var SHA1 = class extends HashMD {
  ...
  get() {
    const { A: A5, B: B3, C: C4, D: D4, E: E5 } = this;
    return [A5, B3, C4, D4, E5];
  }
  set(A5, B3, C4, D4, E5) {
    this.A = A5 | 0;
    this.B = B3 | 0;
  ...
  process(view, offset) {
    ...
    let { A: A5, B: B3, C: C4, D: D4, E: E5 } = this;
    for (let i3 = 0; i3 < 80; i3++) {
      ...
      const T3 = rotl(A5, 5) + F3 + E5 + K4 + SHA1_W[i3] | 0;
      E5 = D4;
      D4 = C4;
      C4 = rotl(B3, 30);
      B3 = A5;
...
var MD5 = class extends HashMD {
  ...
  get() {
    const { A: A5, B: B3, C: C4, D: D4 } = this;
    return [A5, B3, C4, D4];
  }
  set(A5, B3, C4, D4) {
    this.A = A5 | 0;
...
var idxLR = (() => {
  ...
  for (let i3 = 0; i3 < 4; i3++)
    for (let j3 of res)
      j3.push(j3[i3].map((k5) => Rho160[k5]));
  return res;
})();
var idxL = (() => idxLR[0])();
var idxR = (() => idxLR[1])();
...
function ripemd_f(group, x4, y6, z3) {
  if (group === 0)
    return x4 ^ y6 ^ z3;
  if (group === 1)
    return x4 & y6 | ~x4 & z3;
...
var Ki = class extends Rr {
  ...
  process(e, n2) {
    ...
    for (let u3 = 16; u3 < 64; u3++) {
      const h4 = _t[u3 - 15], g = _t[u3 - 2], w2 = gt(h4, 7) ^ gt(h4, 18) ^ h4 >>> 3, y6 = gt(g, 17) ^ gt(g, 19) ^ g >>> 10;
      _t[u3] = y6 + _t[u3 - 7] + w2 + _t[u3 - 16] | 0;
    }
    let { A: r2, B: o2, C: s, D: i3, E: f7, F: a2, G: l4, H: c4 } = this;
    for (let u3 = 0; u3 < 64; u3++) {
      const h4 = gt(f7, 6) ^ gt(f7, 11) ^ gt(f7, 25), g = c4 + h4 + Mi(f7, a2, l4) + qi[u3] + _t[u3] | 0, y6 = (gt(r2, 2) ^ gt(r2, 13) ^ gt(r2, 22)) + Vi(r2, o2, s) | 0;
      c4 = l4, l4 = a2, a2 = f7, f7 = i3 + g | 0, i3 = s, s = o2, o2 = r2, r2 = g + y6 | 0;
    }
...
var cn = class extends Rr {
  ...
  get() {
    const { Ah: e, Al: n2, Bh: r2, Bl: o2, Ch: s, Cl: i3, Dh: f7, Dl: a2, Eh: l4, El: c4, Fh: u3, Fl: h4, Gh: g, Gl: w2, Hh: y6, Hl: x4 } = this;
    return [e, n2, r2, o2, s, i3, f7, a2, l4, c4, u3, h4, g, w2, y6, x4];
  }
  set(e, n2, r2, o2, s, i3, f7, a2, l4, c4, u3, h4, g, w2, y6, x4) {
    this.Ah = e | 0, this.Al = n2 | 0, this.Bh = r2 | 0, this.Bl = o2 | 0, this.Ch = s | 0, this.Cl = i3 | 0, this.Dh = f7 | 0, this.Dl = a2 | 0, this.Eh = l4 | 0, this.El = c4 | 0, this.Fh = u3 | 0, this.Fl = h4 | 0, this.Gh = g | 0, this.Gl = w2 | 0, this.Hh = y6 | 0, this.Hl = x4 | 0;
  }
  process(e, n2) {
    for (let L3 = 0; L3 < 16; L3++, n2 += 4) Tt[L3] = e.getUint32(n2), Rt[L3] = e.getUint32(n2 += 4);
    for (let L3 = 16; L3 < 80; L3++) {
      const V4 = Tt[L3 - 15] | 0, _2 = Rt[L3 - 15] | 0, k5 = At(V4, _2, 1) ^ At(V4, _2, 8) ^ xr(V4, _2, 7), j3 = St(V4, _2, 1) ^ St(V4, _2, 8) ^ vr(V4, _2, 7), $4 = Tt[L3 - 2] | 0, d2 = Rt[L3 - 2] | 0, m2 = At($4, d2, 19) ^ se($4, d2, 61) ^ xr($4, d2, 6), p3 = St($4, d2, 19) ^ ie($4, d2, 61) ^ vr($4, d2, 6), b3 = Ei(j3, p3, Rt[L3 - 7], Rt[L3 - 16]), v3 = Bi(b3, k5, m2, Tt[L3 - 7], Tt[L3 - 16]);
      Tt[L3] = v3 | 0, Rt[L3] = b3 | 0;
    }
    let { Ah: r2, Al: o2, Bh: s, Bl: i3, Ch: f7, Cl: a2, Dh: l4, Dl: c4, Eh: u3, El: h4, Fh: g, Fl: w2, Gh: y6, Gl: x4, Hh: R4, Hl: M4 } = this;
    for (let L3 = 0; L3 < 80; L3++) {
      const V4 = At(u3, h4, 14) ^ At(u3, h4, 18) ^ se(u3, h4, 41), _2 = St(u3, h4, 14) ^ St(u3, h4, 18) ^ ie(u3, h4, 41), k5 = u3 & g ^ ~u3 & y6, j3 = h4 & w2 ^ ~h4 & x4, $4 = Ii(M4, _2, j3, zi[L3], Rt[L3]), d2 = Ai($4, R4, V4, k5, Fi[L3], Tt[L3]), m2 = $4 | 0, p3 = At(r2, o2, 28) ^ se(r2, o2, 34) ^ se(r2, o2, 39), b3 = St(r2, o2, 28) ^ ie(r2, o2, 34) ^ ie(r2, o2, 39), v3 = r2 & s ^ r2 & f7 ^ s & f7, B3 = o2 & i3 ^ o2 & a2 ^ i3 & a2;
      R4 = y6 | 0, M4 = x4 | 0, y6 = g | 0, x4 = w2 | 0, g = u3 | 0, w2 = h4 | 0, { h: u3, l: h4 } = dt(l4 | 0, c4 | 0, d2 | 0, m2 | 0), l4 = f7 | 0, c4 = a2 | 0, f7 = s | 0, a2 = i3 | 0, s = r2 | 0, i3 = o2 | 0;
      const E5 = tn(m2, b3, B3);
      r2 = en(E5, d2, p3, v3), o2 = E5 | 0;
    }
    ({ h: r2, l: o2 } = dt(this.Ah | 0, this.Al | 0, r2 | 0, o2 | 0)), { h: s, l: i3 } = dt(this.Bh | 0, this.Bl | 0, s | 0, i3 | 0), { h: f7, l: a2 } = dt(this.Ch | 0, this.Cl | 0, f7 | 0, a2 | 0), { h: l4, l: c4 } = dt(this.Dh | 0, this.Dl | 0, l4 | 0, c4 | 0), { h: u3, l: h4 } = dt(this.Eh | 0, this.El | 0, u3 | 0, h4 | 0), { h: g, l: w2 } = dt(this.Fh | 0, this.Fl | 0, g | 0, w2 | 0), { h: y6, l: x4 } = dt(this.Gh | 0, this.Gl | 0, y6 | 0, x4 | 0), { h: R4, l: M4 } = dt(this.Hh | 0, this.Hl | 0, R4 | 0, M4 | 0), this.set(r2, o2, s, i3, f7, a2, l4, c4, u3, h4, g, w2, y6, x4, R4, M4);
  }
  roundClean() {
    ut(Tt, Rt);
  }
...
function $t(t, e, n2, r2, o2, s) {
  ...
  let a2 = N[2 * t], l4 = N[2 * t + 1], c4 = N[2 * e], u3 = N[2 * e + 1], h4 = N[2 * n2], g = N[2 * n2 + 1], w2 = N[2 * r2], y6 = N[2 * r2 + 1], x4 = tn(a2, c4, i3);
  l4 = en(x4, l4, u3, f7), a2 = x4 | 0, { Dh: y6, Dl: w2 } = { Dh: y6 ^ l4, Dl: w2 ^ a2 }, { Dh: y6, Dl: w2 } = { Dh: bi(y6, w2), Dl: yi(y6) }, { h: g, l: h4 } = dt(g, h4, y6, w2), { Bh: u3, Bl: c4 } = { Bh: u3 ^ g, Bl: c4 ^ h4 }, { Bh: u3, Bl: c4 } = { Bh: At(u3, c4, 24), Bl: St(u3, c4, 24) }, N[2 * t] = a2, N[2 * t + 1] = l4, N[2 * e] = c4, N[2 * e + 1] = u3, N[2 * n2] = h4, N[2 * n2 + 1] = g, N[2 * r2] = w2, N[2 * r2 + 1] = y6;
}
function Ct(t, e, n2, r2, o2, s) {
  const i3 = o2[s], f7 = o2[s + 1];
  let a2 = N[2 * t], l4 = N[2 * t + 1], c4 = N[2 * e], u3 = N[2 * e + 1], h4 = N[2 * n2], g = N[2 * n2 + 1], w2 = N[2 * r2], y6 = N[2 * r2 + 1], x4 = tn(a2, c4, i3);
  l4 = en(x4, l4, u3, f7), a2 = x4 | 0, { Dh: y6, Dl: w2 } = { Dh: y6 ^ l4, Dl: w2 ^ a2 }, { Dh: y6, Dl: w2 } = { Dh: At(y6, w2, 16), Dl: St(y6, w2, 16) }, { h: g, l: h4 } = dt(g, h4, y6, w2), { Bh: u3, Bl: c4 } = { Bh: u3 ^ g, Bl: c4 ^ h4 }, { Bh: u3, Bl: c4 } = { Bh: se(u3, c4, 63), Bl: ie(u3, c4, 63) }, N[2 * t] = a2, N[2 * t + 1] = l4, N[2 * e] = c4, N[2 * e + 1] = u3, N[2 * n2] = h4, N[2 * n2 + 1] = g, N[2 * r2] = w2, N[2 * r2 + 1] = y6;
}
...
var ef = class extends tf {
  ...
  get() {
    let { v0l: e, v0h: n2, v1l: r2, v1h: o2, v2l: s, v2h: i3, v3l: f7, v3h: a2, v4l: l4, v4h: c4, v5l: u3, v5h: h4, v6l: g, v6h: w2, v7l: y6, v7h: x4 } = this;
    return [e, n2, r2, o2, s, i3, f7, a2, l4, c4, u3, h4, g, w2, y6, x4];
  }
  set(e, n2, r2, o2, s, i3, f7, a2, l4, c4, u3, h4, g, w2, y6, x4) {
    this.v0l = e | 0, this.v0h = n2 | 0, this.v1l = r2 | 0, this.v1h = o2 | 0, this.v2l = s | 0, this.v2h = i3 | 0, this.v3l = f7 | 0, this.v3h = a2 | 0, this.v4l = l4 | 0, this.v4h = c4 | 0, this.v5l = u3 | 0, this.v5h = h4 | 0, this.v6l = g | 0, this.v6h = w2 | 0, this.v7l = y6 | 0, this.v7h = x4 | 0;
  }
  compress(e, n2, r2) {
    this.get().forEach((a2, l4) => N[l4] = a2), N.set(F, 16);
...
var qr = (t, e) => {
  ...
  const s = `URI: ${t.aud || t.uri}`, i3 = `Version: ${t.version}`, f7 = `Chain ID: ${Mr(e)}`, a2 = `Nonce: ${t.nonce}`, l4 = `Issued At: ${t.iat}`, c4 = t.exp ? `Expiration Time: ${t.exp}` : void 0, u3 = t.nbf ? `Not Before: ${t.nbf}` : void 0, h4 = t.requestId ? `Request ID: ${t.requestId}` : void 0, g = t.resources ? `Resources:${t.resources.map((y6) => `
- ${y6}`).join("")}` : void 0, w2 = Oe(t.resources);
  if (w2) {
    const y6 = Lt(w2);
    o2 = gn(o2, y6);
  }
  return [n2, r2, "", o2, "", s, i3, f7, a2, l4, c4, u3, h4, g].filter((y6) => y6 != null).join(`
`);
};
function Gr(t) {
...
function Df(t, e, n2, r2, o2, s, i3, f7) {
  const a2 = o2.length, l4 = new Uint8Array(Ue), c4 = jt(l4), u3 = xn(o2) && xn(s), h4 = u3 ? jt(o2) : so, g = u3 ? jt(s) : so;
  for (let w2 = 0; w2 < a2; i3++) {
    if (t(e, n2, r2, c4, i3, f7), i3 >= oo) throw new Error("arx: counter overflow");
    const y6 = Math.min(Ue, a2 - w2);
    if (u3 && y6 === Ue) {
      const x4 = w2 / 4;
      if (w2 % 4 !== 0) throw new Error("arx: invalid block position");
      for (let R4 = 0, M4; R4 < Hf; R4++) M4 = x4 + R4, g[M4] = h4[M4] ^ c4[R4];
      w2 += Ue;
      continue;
    }
    for (let x4 = 0, R4; x4 < y6; x4++) R4 = w2 + x4, s[R4] = o2[R4] ^ l4[x4];
    w2 += y6;
  }
}
function Mf(t, e) {
  ...
  return yn(o2), yn(i3), bn(s), bn(n2), (f7, a2, l4, c4, u3 = 0) => {
    ...
    const g = [];
    let w2 = f7.length, y6, x4;
    if (w2 === 32) g.push(y6 = wn(f7)), x4 = Pf;
    else if (w2 === 16 && n2) y6 = new Uint8Array(32), y6.set(f7), y6.set(f7, 16), x4 = kf, g.push(y6);
    ...
    const L3 = jt(a2);
    return Df(t, x4, R4, L3, l4, c4, u3, i3), Wt(...g), c4;
  };
}
...
var Vf = class {
  ...
  process(e, n2, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: s, r: i3 } = this, f7 = i3[0], a2 = i3[1], l4 = i3[2], c4 = i3[3], u3 = i3[4], h4 = i3[5], g = i3[6], w2 = i3[7], y6 = i3[8], x4 = i3[9], R4 = G(e, n2 + 0), M4 = G(e, n2 + 2), L3 = G(e, n2 + 4), V4 = G(e, n2 + 6), _2 = G(e, n2 + 8), k5 = G(e, n2 + 10), j3 = G(e, n2 + 12), $4 = G(e, n2 + 14);
    let d2 = s[0] + (R4 & 8191), m2 = s[1] + ((R4 >>> 13 | M4 << 3) & 8191), p3 = s[2] + ((M4 >>> 10 | L3 << 6) & 8191), b3 = s[3] + ((L3 >>> 7 | V4 << 9) & 8191), v3 = s[4] + ((V4 >>> 4 | _2 << 12) & 8191), B3 = s[5] + (_2 >>> 1 & 8191), E5 = s[6] + ((_2 >>> 14 | k5 << 2) & 8191), I4 = s[7] + ((k5 >>> 11 | j3 << 5) & 8191), S4 = s[8] + ((j3 >>> 8 | $4 << 8) & 8191), O5 = s[9] + ($4 >>> 5 | o2), A5 = 0, T3 = A5 + d2 * f7 + m2 * (5 * x4) + p3 * (5 * y6) + b3 * (5 * w2) + v3 * (5 * g);
    A5 = T3 >>> 13, T3 &= 8191, T3 += B3 * (5 * h4) + E5 * (5 * u3) + I4 * (5 * c4) + S4 * (5 * l4) + O5 * (5 * a2), A5 += T3 >>> 13, T3 &= 8191;
    let U4 = A5 + d2 * a2 + m2 * f7 + p3 * (5 * x4) + b3 * (5 * y6) + v3 * (5 * w2);
    A5 = U4 >>> 13, U4 &= 8191, U4 += B3 * (5 * g) + E5 * (5 * h4) + I4 * (5 * u3) + S4 * (5 * c4) + O5 * (5 * l4), A5 += U4 >>> 13, U4 &= 8191;
    let C4 = A5 + d2 * l4 + m2 * a2 + p3 * f7 + b3 * (5 * x4) + v3 * (5 * y6);
    A5 = C4 >>> 13, C4 &= 8191, C4 += B3 * (5 * w2) + E5 * (5 * g) + I4 * (5 * h4) + S4 * (5 * u3) + O5 * (5 * c4), A5 += C4 >>> 13, C4 &= 8191;
    let H2 = A5 + d2 * c4 + m2 * l4 + p3 * a2 + b3 * f7 + v3 * (5 * x4);
    A5 = H2 >>> 13, H2 &= 8191, H2 += B3 * (5 * y6) + E5 * (5 * w2) + I4 * (5 * g) + S4 * (5 * h4) + O5 * (5 * u3), A5 += H2 >>> 13, H2 &= 8191;
    let q2 = A5 + d2 * u3 + m2 * c4 + p3 * l4 + b3 * a2 + v3 * f7;
    A5 = q2 >>> 13, q2 &= 8191, q2 += B3 * (5 * x4) + E5 * (5 * y6) + I4 * (5 * w2) + S4 * (5 * g) + O5 * (5 * h4), A5 += q2 >>> 13, q2 &= 8191;
    let P3 = A5 + d2 * h4 + m2 * u3 + p3 * c4 + b3 * l4 + v3 * a2;
    A5 = P3 >>> 13, P3 &= 8191, P3 += B3 * f7 + E5 * (5 * x4) + I4 * (5 * y6) + S4 * (5 * w2) + O5 * (5 * g), A5 += P3 >>> 13, P3 &= 8191;
    let K4 = A5 + d2 * g + m2 * h4 + p3 * u3 + b3 * c4 + v3 * l4;
    A5 = K4 >>> 13, K4 &= 8191, K4 += B3 * a2 + E5 * f7 + I4 * (5 * x4) + S4 * (5 * y6) + O5 * (5 * w2), A5 += K4 >>> 13, K4 &= 8191;
    let et = A5 + d2 * w2 + m2 * g + p3 * h4 + b3 * u3 + v3 * c4;
    A5 = et >>> 13, et &= 8191, et += B3 * l4 + E5 * a2 + I4 * f7 + S4 * (5 * x4) + O5 * (5 * y6), A5 += et >>> 13, et &= 8191;
    let Z3 = A5 + d2 * y6 + m2 * w2 + p3 * g + b3 * h4 + v3 * u3;
    A5 = Z3 >>> 13, Z3 &= 8191, Z3 += B3 * c4 + E5 * l4 + I4 * a2 + S4 * f7 + O5 * (5 * x4), A5 += Z3 >>> 13, Z3 &= 8191;
    let z3 = A5 + d2 * x4 + m2 * y6 + p3 * w2 + b3 * g + v3 * h4;
    A5 = z3 >>> 13, z3 &= 8191, z3 += B3 * u3 + E5 * c4 + I4 * l4 + S4 * a2 + O5 * f7, A5 += z3 >>> 13, z3 &= 8191, A5 = (A5 << 2) + A5 | 0, A5 = A5 + T3 | 0, T3 = A5 & 8191, A5 = A5 >>> 13, U4 += A5, s[0] = T3, s[1] = U4, s[2] = C4, s[3] = H2, s[4] = q2, s[5] = P3, s[6] = K4, s[7] = et, s[8] = Z3, s[9] = z3;
  }
  finalize() {
...
function Ff(t, e, n2, r2, o2, s = 20) {
  let i3 = t[0], f7 = t[1], a2 = t[2], l4 = t[3], c4 = e[0], u3 = e[1], h4 = e[2], g = e[3], w2 = e[4], y6 = e[5], x4 = e[6], R4 = e[7], M4 = o2, L3 = n2[0], V4 = n2[1], _2 = n2[2], k5 = i3, j3 = f7, $4 = a2, d2 = l4, m2 = c4, p3 = u3, b3 = h4, v3 = g, B3 = w2, E5 = y6, I4 = x4, S4 = R4, O5 = M4, A5 = L3, T3 = V4, U4 = _2;
  for (let H2 = 0; H2 < s; H2 += 2) k5 = k5 + m2 | 0, O5 = D(O5 ^ k5, 16), B3 = B3 + O5 | 0, m2 = D(m2 ^ B3, 12), k5 = k5 + m2 | 0, O5 = D(O5 ^ k5, 8), B3 = B3 + O5 | 0, m2 = D(m2 ^ B3, 7), j3 = j3 + p3 | 0, A5 = D(A5 ^ j3, 16), E5 = E5 + A5 | 0, p3 = D(p3 ^ E5, 12), j3 = j3 + p3 | 0, A5 = D(A5 ^ j3, 8), E5 = E5 + A5 | 0, p3 = D(p3 ^ E5, 7), $4 = $4 + b3 | 0, T3 = D(T3 ^ $4, 16), I4 = I4 + T3 | 0, b3 = D(b3 ^ I4, 12), $4 = $4 + b3 | 0, T3 = D(T3 ^ $4, 8), I4 = I4 + T3 | 0, b3 = D(b3 ^ I4, 7), d2 = d2 + v3 | 0, U4 = D(U4 ^ d2, 16), S4 = S4 + U4 | 0, v3 = D(v3 ^ S4, 12), d2 = d2 + v3 | 0, U4 = D(U4 ^ d2, 8), S4 = S4 + U4 | 0, v3 = D(v3 ^ S4, 7), k5 = k5 + p3 | 0, U4 = D(U4 ^ k5, 16), I4 = I4 + U4 | 0, p3 = D(p3 ^ I4, 12), k5 = k5 + p3 | 0, U4 = D(U4 ^ k5, 8), I4 = I4 + U4 | 0, p3 = D(p3 ^ I4, 7), j3 = j3 + b3 | 0, O5 = D(O5 ^ j3, 16), S4 = S4 + O5 | 0, b3 = D(b3 ^ S4, 12), j3 = j3 + b3 | 0, O5 = D(O5 ^ j3, 8), S4 = S4 + O5 | 0, b3 = D(b3 ^ S4, 7), $4 = $4 + v3 | 0, A5 = D(A5 ^ $4, 16), B3 = B3 + A5 | 0, v3 = D(v3 ^ B3, 12), $4 = $4 + v3 | 0, A5 = D(A5 ^ $4, 8), B3 = B3 + A5 | 0, v3 = D(v3 ^ B3, 7), d2 = d2 + m2 | 0, T3 = D(T3 ^ d2, 16), E5 = E5 + T3 | 0, m2 = D(m2 ^ E5, 12), d2 = d2 + m2 | 0, T3 = D(T3 ^ d2, 8), E5 = E5 + T3 | 0, m2 = D(m2 ^ E5, 7);
  let C4 = 0;
  r2[C4++] = i3 + k5 | 0, r2[C4++] = f7 + j3 | 0, r2[C4++] = a2 + $4 | 0, r2[C4++] = l4 + d2 | 0, r2[C4++] = c4 + m2 | 0, r2[C4++] = u3 + p3 | 0, r2[C4++] = h4 + b3 | 0, r2[C4++] = g + v3 | 0, r2[C4++] = w2 + B3 | 0, r2[C4++] = y6 + E5 | 0, r2[C4++] = x4 + I4 | 0, r2[C4++] = R4 + S4 | 0, r2[C4++] = M4 + O5 | 0, r2[C4++] = L3 + A5 | 0, r2[C4++] = V4 + T3 | 0, r2[C4++] = _2 + U4 | 0;
}
...
function ec(t, e, n2) {
  ...
  }, l4 = (...g) => n2(i3, s, ...g), c4 = (g = r2(0)) => {
    i3 = l4(o2(0), g), s = l4(), g.length !== 0 && (i3 = l4(o2(1), g), s = l4());
  }, u3 = () => {
...
function oc(t) {
  ...
  return function(a2, l4) {
    ...
    let c4 = n2, u3 = a2.mul(a2.ONE, s), h4 = a2.pow(l4, e), g = a2.pow(l4, i3);
    for (; !a2.eql(h4, a2.ONE); ) {
      if (a2.is0(h4)) return a2.ZERO;
      let w2 = 1, y6 = a2.sqr(h4);
      for (; !a2.eql(y6, a2.ONE); ) if (w2++, y6 = a2.sqr(y6), w2 === c4) throw new Error("Cannot find square root");
      const x4 = Q << BigInt(c4 - w2 - 1), R4 = a2.pow(u3, x4);
      c4 = w2, u3 = a2.sqr(R4), h4 = a2.mul(h4, u3), g = a2.mul(g, R4);
    }
    return g;
  };
}
...
function Io(t, e, n2) {
  ...
  f7 > r2 && (f7 -= s, a2 += Mt);
  const l4 = e * r2, c4 = l4 + Math.abs(f7) - 1, u3 = f7 === 0, h4 = f7 < 0, g = e % 2 !== 0;
  return { nextN: a2, offset: c4, isZero: u3, isNeg: h4, isNegF: g, offsetF: l4 };
}
function dc(t, e) {
...
function pc(t, e) {
  return { constTimeNegate: le, hasPrecomputes(n2) {
    ...
    for (let a2 = 0; a2 < f7.windows; a2++) {
      const { nextN: l4, offset: c4, isZero: u3, isNeg: h4, isNegF: g, offsetF: w2 } = Io(o2, a2, f7);
      o2 = l4, u3 ? i3 = i3.add(le(g, r2[w2])) : s = s.add(le(h4, r2[c4]));
    }
...
function bc(t, e, n2, r2) {
  ...
  for (let g = u3; g >= 0; g -= a2) {
    ...
    for (let y6 = 0; y6 < s; y6++) {
      const x4 = r2[y6], R4 = Number(x4 >> BigInt(g) & l4);
      c4[R4] = c4[R4].add(n2[y6]);
    }
    let w2 = i3;
    for (let y6 = c4.length - 1, x4 = i3; y6 > 0; y6--) x4 = x4.add(c4[y6]), w2 = w2.add(x4);
    if (h4 = h4.add(w2), g !== 0) for (let y6 = 0; y6 < a2; y6++) h4 = h4.double();
  }
  return h4;
}
function No(t, e) {
...
function wc(t) {
  ...
  const a2 = i3 || Zt, l4 = f7 ? 255 : 448, c4 = f7 ? 32 : 56, u3 = BigInt(f7 ? 9 : 5), h4 = BigInt(f7 ? 121665 : 39081), g = f7 ? Pe ** BigInt(254) : Pe ** BigInt(447), w2 = f7 ? BigInt(8) * Pe ** BigInt(251) - Jt : BigInt(4) * Pe ** BigInt(445) - Jt, y6 = g + w2 + Jt, x4 = (d2) => lt(d2, n2), R4 = M4(u3);
  function M4(d2) {
    return An(x4(d2), c4);
  }
  function L3(d2) {
    const m2 = rt("u coordinate", d2, c4);
    return f7 && (m2[31] &= 127), x4(Le(m2));
  }
  function V4(d2) {
    return Le(o2(rt("scalar", d2, c4)));
  }
  function _2(d2, m2) {
  ...
  function j3(d2, m2, p3) {
    const b3 = x4(d2 * (m2 - p3));
    return m2 = x4(m2 - b3), p3 = x4(p3 + b3), { x_2: m2, x_3: p3 };
  }
  function $4(d2, m2) {
    Nn("u", d2, de, n2), Nn("scalar", m2, g, y6);
    const p3 = m2, b3 = d2;
    let v3 = Jt, B3 = de, E5 = d2, I4 = Jt, S4 = de;
    for (let A5 = BigInt(l4 - 1); A5 >= de; A5--) {
      const T3 = p3 >> A5 & Jt;
      S4 ^= T3, { x_2: v3, x_3: E5 } = j3(S4, v3, E5), { x_2: B3, x_3: I4 } = j3(S4, B3, I4), S4 = T3;
      const U4 = v3 + B3, C4 = x4(U4 * U4), H2 = v3 - B3, q2 = x4(H2 * H2), P3 = C4 - q2, K4 = E5 + I4, et = E5 - I4, Z3 = x4(et * U4), z3 = x4(K4 * H2), Ft2 = Z3 + z3, yt3 = Z3 - z3;
      E5 = x4(Ft2 * Ft2), I4 = x4(b3 * x4(yt3 * yt3)), v3 = x4(C4 * q2), B3 = x4(P3 * (C4 + x4(h4 * P3)));
    }
    ({ x_2: v3, x_3: E5 } = j3(S4, v3, E5)), { x_2: B3, x_3: I4 } = j3(S4, B3, I4);
    const O5 = s(B3);
    return x4(v3 * O5);
  }
  return { scalarMult: _2, scalarMultBase: k5, getSharedSecret: (d2, m2) => _2(d2, m2), getPublicKey: (d2) => k5(d2), utils: { randomPrivateKey: () => a2(c4) }, GuBytes: R4.slice() };
}
BigInt(0);
var xc = BigInt(1);
var Oo = BigInt(2);
...
function Ic(t) {
  const e = BigInt(10), n2 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), s = Uo.p, f7 = t * t % s * t % s, a2 = pt(f7, Oo, s) * f7 % s, l4 = pt(a2, xc, s) * t % s, c4 = pt(l4, Ec, s) * l4 % s, u3 = pt(c4, e, s) * c4 % s, h4 = pt(u3, n2, s) * u3 % s, g = pt(h4, r2, s) * h4 % s, w2 = pt(g, o2, s) * g % s, y6 = pt(w2, o2, s) * g % s, x4 = pt(y6, e, s) * c4 % s;
...
function _c(t, e = {}) {
  ...
  function l4($4) {
    ...
    if (b3 === m2 && (v3 === 2 || v3 === 3)) {
      ...
      return (v3 & 1) === 1 !== O5 && (S4 = n2.neg(S4)), { x: E5, y: S4 };
    } else if (b3 === p3 && v3 === 4) {
      const E5 = n2.fromBytes(B3.subarray(d2 * 0, d2 * 1)), I4 = n2.fromBytes(B3.subarray(d2 * 1, d2 * 2));
      if (!g(E5, I4)) throw new Error("bad point: is not on curve");
      return { x: E5, y: I4 };
  ...
  const w2 = n2.mul(n2.pow(t.a, He), Oc), y6 = n2.mul(n2.sqr(t.b), BigInt(27));
  if (n2.is0(n2.add(w2, y6))) throw new Error("bad curve params: a or b");
  function x4($4, d2, m2 = false) {
    if (!n2.isValid(d2) || m2 && n2.is0(d2)) throw new Error(`bad point coordinate ${$4}`);
    return d2;
  }
  function R4($4) {
    if (!($4 instanceof _2)) throw new Error("ProjectivePoint expected");
  }
  const M4 = ho(($4, d2) => {
    ...
    const B3 = n2.mul(m2, d2), E5 = n2.mul(p3, d2), I4 = n2.mul(b3, d2);
  ...
  function V4($4, d2, m2, p3, b3) {
    return m2 = new _2(n2.mul(m2.px, $4), m2.py, m2.pz), d2 = le(p3, d2), m2 = le(b3, m2), d2.add(m2);
  }
  class _2 {
    constructor(d2, m2, p3) {
      this.px = x4("x", d2), this.py = x4("y", m2, true), this.pz = x4("z", p3), Object.freeze(this);
    }
    static fromAffine(d2) {
      const { x: m2, y: p3 } = d2 || {};
      if (!d2 || !n2.isValid(m2) || !n2.isValid(p3)) throw new Error("invalid affine point");
      if (d2 instanceof _2) throw new Error("projective point not allowed");
      return n2.is0(m2) && n2.is0(p3) ? _2.ZERO : new _2(m2, p3, n2.ONE);
    }
    get x() {
    ...
    static fromBytes(d2) {
      return at(d2), _2.fromHex(d2);
    }
    static fromHex(d2) {
      const m2 = _2.fromAffine(u3(rt("pointHex", d2)));
      return m2.assertValidity(), m2;
    }
    static fromPrivateKey(d2) {
      const m2 = To(r2, e.allowedPrivateKeyLengths, e.wrapPrivateKey);
      return _2.BASE.multiply(m2(d2));
    }
    static msm(d2, m2) {
      return bc(_2, r2, d2, m2);
    }
    precompute(d2 = 8, m2 = true) {
      return j3.setWindowSize(this, d2), m2 || this.multiply(He), this;
    }
    _setWindowSize(d2) {
      this.precompute(d2);
    }
    ...
    equals(d2) {
      R4(d2);
      const { px: m2, py: p3, pz: b3 } = this, { px: v3, py: B3, pz: E5 } = d2, I4 = n2.eql(n2.mul(m2, E5), n2.mul(v3, b3)), S4 = n2.eql(n2.mul(p3, E5), n2.mul(B3, b3));
      return I4 && S4;
    }
    negate() {
    ...
    double() {
      ...
      let E5 = n2.ZERO, I4 = n2.ZERO, S4 = n2.ZERO, O5 = n2.mul(b3, b3), A5 = n2.mul(v3, v3), T3 = n2.mul(B3, B3), U4 = n2.mul(b3, v3);
      return U4 = n2.add(U4, U4), S4 = n2.mul(b3, B3), S4 = n2.add(S4, S4), E5 = n2.mul(d2, S4), I4 = n2.mul(p3, T3), I4 = n2.add(E5, I4), E5 = n2.sub(A5, I4), I4 = n2.add(A5, I4), I4 = n2.mul(E5, I4), E5 = n2.mul(U4, E5), S4 = n2.mul(p3, S4), T3 = n2.mul(d2, T3), U4 = n2.sub(O5, T3), U4 = n2.mul(d2, U4), U4 = n2.add(U4, S4), S4 = n2.add(O5, O5), O5 = n2.add(S4, O5), O5 = n2.add(O5, T3), O5 = n2.mul(O5, U4), I4 = n2.add(I4, O5), T3 = n2.mul(v3, B3), T3 = n2.add(T3, T3), O5 = n2.mul(T3, U4), E5 = n2.sub(E5, O5), S4 = n2.mul(T3, A5), S4 = n2.add(S4, S4), S4 = n2.add(S4, S4), new _2(E5, I4, S4);
    }
    add(d2) {
      R4(d2);
      const { px: m2, py: p3, pz: b3 } = this, { px: v3, py: B3, pz: E5 } = d2;
      let I4 = n2.ZERO, S4 = n2.ZERO, O5 = n2.ZERO;
      const A5 = t.a, T3 = n2.mul(t.b, He);
      let U4 = n2.mul(m2, v3), C4 = n2.mul(p3, B3), H2 = n2.mul(b3, E5), q2 = n2.add(m2, p3), P3 = n2.add(v3, B3);
      q2 = n2.mul(q2, P3), P3 = n2.add(U4, C4), q2 = n2.sub(q2, P3), P3 = n2.add(m2, b3);
      let K4 = n2.add(v3, E5);
      return P3 = n2.mul(P3, K4), K4 = n2.add(U4, H2), P3 = n2.sub(P3, K4), K4 = n2.add(p3, b3), I4 = n2.add(B3, E5), K4 = n2.mul(K4, I4), I4 = n2.add(C4, H2), K4 = n2.sub(K4, I4), O5 = n2.mul(A5, P3), I4 = n2.mul(T3, H2), O5 = n2.add(I4, O5), I4 = n2.sub(C4, O5), O5 = n2.add(C4, O5), S4 = n2.mul(I4, O5), C4 = n2.add(U4, U4), C4 = n2.add(C4, U4), H2 = n2.mul(A5, H2), P3 = n2.mul(T3, P3), C4 = n2.add(C4, H2), H2 = n2.sub(U4, H2), H2 = n2.mul(A5, H2), P3 = n2.add(P3, H2), U4 = n2.mul(C4, P3), S4 = n2.add(S4, U4), U4 = n2.mul(K4, P3), I4 = n2.mul(q2, I4), I4 = n2.sub(I4, U4), U4 = n2.mul(q2, C4), O5 = n2.mul(K4, O5), O5 = n2.add(O5, U4), new _2(I4, S4, O5);
    }
    subtract(d2) {
    ...
    multiply(d2) {
      ...
      if (m2) {
        const { k1neg: B3, k1: E5, k2neg: I4, k2: S4 } = m2.splitScalar(d2), { p: O5, f: A5 } = v3(E5), { p: T3, f: U4 } = v3(S4);
        b3 = A5.add(U4), p3 = V4(m2.beta, O5, T3, B3, I4);
      } else {
        const { p: B3, f: E5 } = v3(d2);
        p3 = B3, b3 = E5;
      }
      return _2.normalizeZ([p3, b3])[0];
    }
    multiplyUnsafe(d2) {
      const { endo: m2 } = e, p3 = this;
      if (!r2.isValid(d2)) throw new Error("invalid scalar: out of range");
      if (d2 === he || p3.is0()) return _2.ZERO;
      if (d2 === pe) return p3;
      if (j3.hasPrecomputes(this)) return this.multiply(d2);
      if (m2) {
        const { k1neg: b3, k1: v3, k2neg: B3, k2: E5 } = m2.splitScalar(d2), { p1: I4, p2: S4 } = gc(_2, p3, v3, E5);
        return V4(m2.beta, I4, S4, b3, B3);
      } else return j3.wNAFCachedUnsafe(p3, d2);
    }
    ...
    isTorsionFree() {
      ...
      return o2 === pe ? true : d2 ? d2(_2, this) : j3.wNAFCachedUnsafe(this, s).is0();
    }
    clearCofactor() {
      const { clearCofactor: d2 } = e;
      return o2 === pe ? this : d2 ? d2(_2, this) : this.multiplyUnsafe(o2);
    }
    toBytes(d2 = true) {
      return Re("isCompressed", d2), this.assertValidity(), c4(_2, this, d2);
    }
    toRawBytes(d2 = true) {
  ...
  const k5 = r2.BITS, j3 = pc(_2, e.endo ? Math.ceil(k5 / 2) : k5);
  return _2;
}
function Ro(t) {
...
function Tc(t, e, n2 = {}) {
  ...
  class h4 {
    ...
    recoverPublicKey(b3) {
      const v3 = s.ORDER, { r: B3, s: E5, recovery: I4 } = this;
      ...
      const A5 = s.toBytes(O5), T3 = t.fromHex(Ht(Ro((I4 & 1) === 0), A5)), U4 = i3.inv(O5), C4 = L3(rt("msgHash", b3)), H2 = i3.create(-C4 * U4), q2 = i3.create(E5 * U4), P3 = t.BASE.multiplyUnsafe(H2).add(T3.multiplyUnsafe(q2));
  ...
  function y6(p3, b3 = true) {
    return t.fromPrivateKey(p3).toBytes(b3);
  }
  function x4(p3) {
    if (typeof p3 == "bigint") return false;
    if (p3 instanceof t) return true;
    const v3 = rt("key", p3).length, B3 = s.BYTES, E5 = B3 + 1, I4 = 2 * B3 + 1;
    if (!(n2.allowedPrivateKeyLengths || i3.BYTES === E5)) return v3 === E5 || v3 === I4;
  }
  function R4(p3, b3, v3 = true) {
    if (x4(p3) === true) throw new Error("first arg must be private key");
  ...
  function k5(p3, b3, v3 = j3) {
    if (["recovered", "canonical"].some((q2) => q2 in v3)) throw new Error("sign() legacy options not supported");
    const { hash: B3 } = e;
    let { lowS: E5, prehash: I4, extraEntropy: S4 } = v3;
    E5 == null && (E5 = true), p3 = rt("msgHash", p3), _o(v3), I4 && (p3 = rt("prehashed msgHash", B3(p3)));
    const O5 = L3(p3), A5 = g(b3), T3 = [_2(A5), _2(O5)];
    if (S4 != null && S4 !== false) {
    ...
    function H2(q2) {
      ...
      const K4 = i3.inv(P3), et = t.BASE.multiply(P3).toAffine(), Z3 = i3.create(et.x);
      if (Z3 === he) return;
      const z3 = i3.create(K4 * i3.create(C4 + Z3 * A5));
      if (z3 === he) return;
      let Ft2 = (et.x === Z3 ? 0 : 2) | Number(et.y & pe), yt3 = z3;
      return E5 && l4(z3) && (yt3 = c4(z3), Ft2 ^= 1), new h4(Z3, yt3, Ft2);
    }
    return { seed: U4, k2sig: H2 };
  }
  const j3 = { lowS: e.lowS, prehash: false }, $4 = { lowS: e.lowS, prehash: false };
  function d2(p3, b3, v3 = j3) {
    const { seed: B3, k2sig: E5 } = k5(p3, b3, v3);
    return ec(e.hash.outputLen, i3.BYTES, o2)(B3, E5);
  }
  t.BASE.precompute(8);
  function m2(p3, b3, v3, B3 = $4) {
    ...
    const A5 = typeof E5 == "string" || nn(E5), T3 = !A5 && !O5 && typeof E5 == "object" && E5 !== null && typeof E5.r == "bigint" && typeof E5.s == "bigint";
    if (!A5 && !T3) throw new Error("invalid signature, expected Uint8Array, hex string or Signature instance");
    let U4, C4;
    try {
      if (T3) if (O5 === void 0 || O5 === "js") U4 = new h4(E5.r, E5.s);
    ...
    S4 && (b3 = e.hash(b3));
    const { r: H2, s: q2 } = U4, P3 = L3(b3), K4 = i3.inv(q2), et = i3.create(P3 * K4), Z3 = i3.create(H2 * K4), z3 = t.BASE.multiplyUnsafe(et).add(C4.multiplyUnsafe(Z3));
    return z3.is0() ? false : i3.create(z3.x) === H2;
  }
  return Object.freeze({ getPublicKey: y6, getSharedSecret: R4, sign: d2, verify: m2, utils: w2, Point: t, Signature: h4 });
}
function Rc(t) {
...
function bs({ publicKey: t, signature: e, payload: n2 }) {
  ...
  const a2 = parseInt(n2.nonce, 16), l4 = new Uint8Array([a2 & 255, a2 >> 8 & 255]), c4 = BigInt(`0x${Da(n2.tip)}`), u3 = qa(c4), h4 = new Uint8Array([0, ...t, i3, ...e, ...f7, ...l4, ...u3, ...o2]), g = Va(h4.length + 1);
...
function nr(r2, e) {
  ...
  function d2(u3) {
    ...
    for (var b3 = 0, x4 = 0, I4 = 0, D4 = u3.length; I4 !== D4 && u3[I4] === 0; ) I4++, b3++;
    for (var j3 = (D4 - I4) * l4 + 1 >>> 0, T3 = new Uint8Array(j3); I4 !== D4; ) {
      for (var q2 = u3[I4], J3 = 0, K4 = j3 - 1; (q2 !== 0 || J3 < x4) && K4 !== -1; K4--, J3++) q2 += 256 * T3[K4] >>> 0, T3[K4] = q2 % a2 >>> 0, q2 = q2 / a2 >>> 0;
      if (q2 !== 0) throw new Error("Non-zero carry");
      x4 = J3, I4++;
    }
    for (var H2 = j3 - x4; H2 !== j3 && T3[H2] === 0; ) H2++;
    for (var me4 = c4.repeat(b3); H2 < j3; ++H2) me4 += r2.charAt(T3[H2]);
    return me4;
  }
  function g(u3) {
    ...
    var b3 = 0;
    if (u3[b3] !== " ") {
      for (var x4 = 0, I4 = 0; u3[b3] === c4; ) x4++, b3++;
      for (var D4 = (u3.length - b3) * h4 + 1 >>> 0, j3 = new Uint8Array(D4); u3[b3]; ) {
        var T3 = t[u3.charCodeAt(b3)];
        if (T3 === 255) return;
        for (var q2 = 0, J3 = D4 - 1; (T3 !== 0 || q2 < I4) && J3 !== -1; J3--, q2++) T3 += a2 * j3[J3] >>> 0, j3[J3] = T3 % 256 >>> 0, T3 = T3 / 256 >>> 0;
        if (T3 !== 0) throw new Error("Non-zero carry");
        I4 = q2, b3++;
      }
      if (u3[b3] !== " ") {
        for (var K4 = D4 - I4; K4 !== D4 && j3[K4] === 0; ) K4++;
        for (var H2 = new Uint8Array(x4 + (D4 - K4)), me4 = x4; K4 !== D4; ) H2[me4++] = j3[K4++];
        return H2;
      }
    }
  }
...
var pr2 = (r2, e, t, i3) => {
  ...
  for (let l4 = 0; l4 < n2; ++l4) {
    ...
    c4 = c4 << t | d2, a2 += t, a2 >= 8 && (a2 -= 8, o2[h4++] = 255 & c4 >> a2);
  }
...
var wi2 = class {
  constructor(e, t, i3) {
    this.core = e, this.logger = t, S2(this, "name", Tt2), S2(this, "keychain"), S2(this, "randomSessionIdentifier", qc()), S2(this, "initialized", false), S2(this, "init", async () => {
      ...
      if (Qc(a2)) return Wc(c4, o2?.encoding);
      if (Jc(a2)) {
        const g = a2.senderPublicKey, _2 = a2.receiverPublicKey;
        s = await this.generateSharedKey(g, _2);
      }
      const h4 = this.getSymKey(s), { type: l4, senderPublicKey: d2 } = a2;
      return Gc({ type: l4, symKey: h4, message: c4, senderPublicKey: d2, encoding: o2?.encoding });
    }), S2(this, "decode", async (s, n2, o2) => {
      this.isInitialized();
      const a2 = Xc(n2, o2);
      if (Qc(a2)) {
        const c4 = Yc(n2, o2?.encoding);
      ...
      try {
        const c4 = this.getSymKey(s), h4 = Zc({ symKey: c4, encoded: n2, encoding: o2?.encoding });
  ...
  constructor(e, t) {
    super(e, t), this.logger = e, this.core = t, k4(this, "messages", /* @__PURE__ */ new Map()), k4(this, "messagesWithoutClientAck", /* @__PURE__ */ new Map()), k4(this, "name", Ot2), k4(this, "version", Rt2), k4(this, "initialized", false), k4(this, "storagePrefix", B), k4(this, "init", async () => {
      ...
      if (a2[o2] = s, this.messages.set(i3, a2), n2 === le2.inbound) {
        ...
        this.messagesWithoutClientAck.set(i3, Fn2(Un2({}, c4), { [o2]: s }));
      }
...
var Gn = class extends m {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, V2(this, "events", new import_events3.EventEmitter()), V2(this, "name", At2), V2(this, "queue", /* @__PURE__ */ new Map()), V2(this, "publishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), V2(this, "initialPublishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), V2(this, "needsTransportRestart", false), V2(this, "publish", async (i3, s, n2) => {
      ...
      const a2 = n2?.ttl || je2, c4 = ea(n2), h4 = n2?.prompt || false, l4 = n2?.tag || 0, d2 = n2?.id || getBigIntRpcId().toString(), g = { topic: i3, message: s, opts: { ttl: a2, relay: c4, prompt: h4, tag: l4, id: d2, attestation: n2?.attestation, tvf: n2?.tvf } }, _2 = `Failed to publish payload, please try again. id:${d2} tag:${l4}`;
      try {
        const u3 = new Promise(async (b3) => {
          const x4 = ({ id: D4 }) => {
            g.opts.id === D4 && (this.removeRequestFromQueue(D4), this.relayer.events.removeListener(C2.publish, x4), b3(g));
          };
          this.relayer.events.on(C2.publish, x4);
          const I4 = ni(new Promise((D4, j3) => {
            this.rpcPublish({ topic: i3, message: s, ttl: a2, prompt: h4, tag: l4, id: d2, attestation: n2?.attestation, tvf: n2?.tvf }).then(D4).catch((T3) => {
          ...
          try {
            ...
            this.queue.set(d2, Ge(Ie2({}, g), { attempt: 1 })), this.logger.warn(D4, D4?.message);
          }
        });
        this.logger.trace({ type: "method", method: "publish", params: { id: d2, topic: i3, message: s, opts: n2 } }), await ni(u3, this.publishTimeout, _2);
      } catch (u3) {
  ...
  async rpcPublish(e) {
    var t, i3, s, n2;
    const { topic: o2, message: a2, ttl: c4 = je2, prompt: h4, tag: l4, id: d2, attestation: g, tvf: _2 } = e, u3 = { method: na(ea().protocol).publish, params: Ie2({ topic: o2, message: a2, ttl: c4, prompt: h4, tag: l4, attestation: g }, _2), id: d2 };
  ...
  async rpcSubscribe(e, t, i3) {
    ...
    try {
      ...
      const c4 = new Promise(async (l4) => {
        const d2 = (g) => {
          g.topic === e && (this.events.removeListener($.created, d2), l4(g.id));
        };
        this.events.on($.created, d2);
        try {
          const g = await ni(new Promise((_2, u3) => {
    ...
    switch (s) {
      ...
      case go2: {
        ...
        for (let l4 = 0; l4 < c4.length; l4++) {
          const d2 = c4[l4], g = h4.findIndex((_2) => pe2(d2, _2, void 0, r2, e, t, i3));
          if (g === -1) return false;
          h4.splice(g, 1);
        }
        return true;
...
var Li2 = class extends f3 {
  constructor(e, t, i3, s = B, n2 = void 0) {
    ...
    }), z2(this, "get", (o2) => (this.isInitialized(), this.logger.debug("Getting value"), this.logger.trace({ type: "method", method: "get", key: o2 }), this.getData(o2))), z2(this, "getAll", (o2) => (this.isInitialized(), o2 ? this.values.filter((a2) => Object.keys(o2).every((c4) => xo2(a2[c4], o2[c4]))) : this.values)), z2(this, "update", async (o2, a2) => {
      this.isInitialized(), this.logger.debug("Updating value"), this.logger.trace({ type: "method", method: "update", key: o2, update: a2 });
      const c4 = zi2(zi2({}, this.getData(o2)), a2);
...
var ki2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, p2(this, "name", Mt2), p2(this, "version", Kt2), p2(this, "events", new import_events3.default()), p2(this, "pairings"), p2(this, "initialized", false), p2(this, "storagePrefix", B), p2(this, "ignoredPayloadTypes", [ee]), p2(this, "registeredMethods", []), p2(this, "init", async () => {
      ...
      this.isInitialized();
      const s = qc(), n2 = await this.core.crypto.setSymKey(s), o2 = ii(import_time2.FIVE_MINUTES), a2 = { protocol: xt2 }, c4 = { topic: n2, expiry: o2, relay: a2, active: false, methods: i3?.methods }, h4 = oa({ protocol: this.core.protocol, version: this.core.version, topic: n2, symKey: s, relay: a2, expiryTimestamp: o2, methods: i3?.methods });
      return this.events.emit(re.create, c4), this.core.expirer.set(n2, o2), await this.pairings.set(n2, c4), await this.core.relayer.subscribe(n2, { transportType: i3?.transportType }), { topic: n2, uri: h4 };
      ...
      const d2 = c4 || ii(import_time2.FIVE_MINUTES), g = { topic: n2, relay: a2, expiry: d2, active: false, methods: h4 };
...
var O3 = (r2, e, t) => Uo2(r2, typeof e != "symbol" ? e + "" : e, t);
...
var Fi2 = class extends M {
  constructor(e, t, i3) {
    super(e, t, i3), this.core = e, this.logger = t, this.store = i3, w(this, "name", Wt2), w(this, "abortController"), w(this, "isDevEnv"), w(this, "verifyUrlV3", Yt2), w(this, "storagePrefix", B), w(this, "version", Le2), w(this, "publicKey"), w(this, "fetchPromise"), w(this, "init", async () => {
      ...
      try {
        const h4 = (0, import_window_getters2.getDocument)(), l4 = this.startAbortTimer(import_time2.ONE_SECOND * 5), d2 = await new Promise((g, _2) => {
          const u3 = () => {
            window.removeEventListener("message", x4), h4.body.removeChild(b3), _2("attestation aborted");
          };
          ...
          const x4 = (I4) => {
            if (I4.data && typeof I4.data == "string") try {
              ...
              if (D4.type === "verify_attestation") {
                ...
                clearInterval(l4), h4.body.removeChild(b3), this.abortController.signal.removeEventListener("abort", u3), window.removeEventListener("message", x4), g(D4.attestation === null ? "" : D4.attestation);
              }
            } catch (D4) {
              this.logger.warn(D4);
            }
          };
          h4.body.appendChild(b3), window.addEventListener("message", x4, { signal: this.abortController.signal });
        });
...
var Ki2 = class extends O2 {
  constructor(e, t) {
    super(e, t), this.projectId = e, this.logger = t, Mi2(this, "context", Xt2), Mi2(this, "registerDeviceToken", async (i3) => {
      const { clientId: s, token: n2, notificationType: o2, enableEncrypted: a2 = false } = i3, c4 = `${Zt2}/${this.projectId}/clients`;
...
var Vi2 = class extends R {
  constructor(e, t, i3 = true) {
    super(e, t, i3), this.core = e, this.logger = t, E3(this, "context", ei2), E3(this, "storagePrefix", B), E3(this, "storageVersion", Qt2), E3(this, "events", /* @__PURE__ */ new Map()), E3(this, "shouldPersist", false), E3(this, "init", async () => {
      ...
      const { event: n2 = "ERROR", type: o2 = "", properties: { topic: a2, trace: c4 } } = s, h4 = di(), l4 = this.core.projectId || "", d2 = Date.now(), g = be2({ eventId: h4, timestamp: d2, props: { event: n2, type: o2, properties: { topic: a2, trace: c4 } }, bundleId: l4, domain: this.getAppDomain() }, this.setMethods(h4));
    ...
    }), E3(this, "getAppDomain", () => sr().url), this.logger = E(t, this.context), this.telemetryEnabled = i3, i3 ? this.restore().then(async () => {
...
var Cs2 = class extends V {
  constructor(o2) {
    super(o2), c3(this, "name", ut2), c3(this, "events", new import_events4.default()), c3(this, "initialized", false), c3(this, "requestQueue", { state: $2.idle, queue: [] }), c3(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c3(this, "emittedSessionRequests", new gi({ limit: 500 })), c3(this, "requestQueueDelay", import_time3.ONE_SECOND), c3(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c3(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c3(this, "recentlyDeletedLimit", 200), c3(this, "relayMessageCache", []), c3(this, "pendingSessions", /* @__PURE__ */ new Map()), c3(this, "init", async () => {
      ...
      const e = x2(I2({}, t), { requiredNamespaces: t.requiredNamespaces || {}, optionalNamespaces: t.optionalNamespaces || {} });
      ...
      const d2 = await this.client.core.crypto.generateKeyPair(), w2 = N3.wc_sessionPropose.req.ttl || import_time3.FIVE_MINUTES, m2 = ii(w2), y6 = x2(I2(I2({ requiredNamespaces: i3, optionalNamespaces: r2, relays: l4 ?? [{ protocol: xt2 }], proposer: { publicKey: d2, metadata: this.client.metadata }, expiryTimestamp: m2, pairingTopic: p3 }, n2 && { sessionProperties: n2 }), a2 && { scopedProperties: a2 }), { id: payloadId() }), E5 = ci("session_connect", y6.id), { reject: _2, resolve: V4, done: C4 } = ei(w2, Me3), v3 = ({ id: T3 }) => {
        T3 === y6.id && (this.client.events.off("proposal_expire", v3), this.pendingSessions.delete(y6.id), this.events.emit(E5, { error: { message: Me3, code: 0 } }));
      };
      return this.client.events.on("proposal_expire", v3), this.events.once(E5, ({ error: T3, session: K4 }) => {
        this.client.events.off("proposal_expire", v3), T3 ? _2(T3) : K4 && V4(K4);
      }), await this.sendRequest({ topic: p3, method: "wc_sessionPropose", params: y6, throwOnFailedPublish: true, clientRpcId: y6.id }), await this.setProposal(y6.id, y6), { uri: h4, approval: C4 };
      ...
      const { id: n2, relayProtocol: a2, namespaces: l4, sessionProperties: p3, scopedProperties: h4, sessionConfig: u3 } = t, d2 = this.client.proposal.get(n2);
      this.client.core.eventClient.deleteEvent({ eventId: r2.eventId });
      const { pairingTopic: w2, proposer: m2, requiredNamespaces: y6, optionalNamespaces: E5 } = d2;
      let _2 = (s = this.client.core.eventClient) == null ? void 0 : s.getEvent({ topic: w2 });
      _2 || (_2 = (i3 = this.client.core.eventClient) == null ? void 0 : i3.createEvent({ type: tr2.session_approve_started, properties: { topic: w2, trace: [tr2.session_approve_started, tr2.session_namespaces_validation_success] } }));
      const V4 = await this.client.core.crypto.generateKeyPair(), C4 = m2.publicKey, v3 = await this.client.core.crypto.generateSharedKey(V4, C4), T3 = I2(I2(I2({ relay: { protocol: a2 ?? "irn" }, namespaces: l4, controller: { publicKey: V4, metadata: this.client.metadata }, expiry: ii(X2) }, p3 && { sessionProperties: p3 }), h4 && { scopedProperties: h4 }), u3 && { sessionConfig: u3 }), K4 = Q2.relay;
      _2.addTrace(tr2.subscribing_session_topic);
      try {
        await this.client.core.relayer.subscribe(v3, { transportType: K4 });
      } catch (q2) {
        throw _2.setError(ir2.subscribe_session_topic_failure), q2;
      }
      _2.addTrace(tr2.subscribe_session_topic_success);
      const fe4 = x2(I2({}, T3), { topic: v3, requiredNamespaces: y6, optionalNamespaces: E5, pairingTopic: w2, acknowledged: false, self: T3.controller, peer: { publicKey: m2.publicKey, metadata: m2.metadata }, controller: V4, transportType: Q2.relay });
      await this.client.session.set(v3, fe4), _2.addTrace(tr2.store_session);
      try {
        _2.addTrace(tr2.publishing_session_settle), await this.sendRequest({ topic: v3, method: "wc_sessionSettle", params: T3, throwOnFailedPublish: true }).catch((q2) => {
          throw _2?.setError(ir2.session_settle_publish_failure), q2;
        }), _2.addTrace(tr2.session_settle_publish_success), _2.addTrace(tr2.publishing_session_approve), await this.sendResult({ id: n2, topic: w2, result: { relay: { protocol: a2 ?? "irn" }, responderPublicKey: V4 }, throwOnFailedPublish: true }).catch((q2) => {
          throw _2?.setError(ir2.session_approve_publish_failure), q2;
        }), _2.addTrace(tr2.session_approve_publish_success);
      } catch (q2) {
      ...
      return this.client.core.eventClient.deleteEvent({ eventId: _2.eventId }), await this.client.core.pairing.updateMetadata({ topic: w2, metadata: m2.metadata }), await this.deleteProposal(n2), await this.client.core.pairing.activate({ topic: w2 }), await this.setExpiry(v3, ii(X2)), { topic: v3, acknowledged: () => Promise.resolve(this.client.session.get(v3)) };
      ...
      i3 && await this.sendError({ id: e, topic: i3, error: s, rpcOpts: N3.wc_sessionPropose.reject }), await this.deleteProposal(e);
      ...
      const { topic: e, namespaces: s } = t, { done: i3, resolve: r2, reject: n2 } = ei(), a2 = payloadId(), l4 = getBigIntRpcId().toString(), p3 = this.client.session.get(e).namespaces;
      ...
      const { chainId: e, request: s, topic: i3, expiry: r2 = N3.wc_sessionRequest.req.ttl } = t, n2 = this.client.session.get(i3);
      n2?.transportType === Q2.relay && await this.confirmOnlineStateOrThrow();
      const a2 = payloadId(), l4 = getBigIntRpcId().toString(), { done: p3, resolve: h4, reject: u3 } = ei(r2, "Request expired. Please try again.");
      this.events.once(ci("session_request", a2), ({ error: y6, result: E5 }) => {
        y6 ? u3(y6) : h4(E5);
      });
      const d2 = "wc_sessionRequest", w2 = this.getAppLinkIfEnabled(n2.peer.metadata, n2.transportType);
      if (w2) return await this.sendRequest({ clientRpcId: a2, relayRpcId: l4, topic: i3, method: d2, params: { request: x2(I2({}, s), { expiryTimestamp: ii(r2) }), chainId: e }, expiry: r2, throwOnFailedPublish: true, appLink: w2 }).catch((y6) => u3(y6)), this.client.events.emit("session_request_sent", { topic: i3, request: s, chainId: e, id: a2 }), await p3();
      const m2 = { request: x2(I2({}, s), { expiryTimestamp: ii(r2) }), chainId: e };
      return await Promise.all([new Promise(async (y6) => {
        await this.sendRequest({ clientRpcId: a2, relayRpcId: l4, topic: i3, method: d2, params: m2, expiry: r2, throwOnFailedPublish: true, tvf: this.getTVFParams(a2, m2) }).catch((E5) => u3(E5)), this.client.events.emit("session_request_sent", { topic: i3, request: s, chainId: e, id: a2 }), y6();
      }), new Promise(async (y6) => {
        var E5;
        if (!((E5 = n2.sessionConfig) != null && E5.disableDeepLink)) {
          const _2 = await ui(this.client.core.storage, Le3);
      ...
      const { chains: n2, statement: a2 = "", uri: l4, domain: p3, nonce: h4, type: u3, exp: d2, nbf: w2, methods: m2 = [], expiry: y6 } = t, E5 = [...t.resources || []], { topic: _2, uri: V4 } = await this.client.core.pairing.create({ methods: ["wc_sessionAuthenticate"], transportType: r2 });
      this.client.logger.info({ message: "Generated new pairing", pairing: { topic: _2, uri: V4 } });
      const C4 = await this.client.core.crypto.generateKeyPair(), v3 = Fc(C4);
      if (await Promise.all([this.client.auth.authKeys.set(ce2, { responseTopic: v3, publicKey: C4 }), this.client.auth.pairingTopics.set(v3, { topic: v3, pairingTopic: _2 })]), await this.client.core.relayer.subscribe(v3, { transportType: r2 }), this.client.logger.info(`sending request to new pairing topic: ${_2}`), m2.length > 0) {
        const { namespace: O5 } = Fe(n2[0]);
        let k5 = Ef(O5, "request", m2);
        Oe(E5) && (k5 = Bf(k5, E5.pop())), E5.push(k5);
      }
      const T3 = y6 && y6 > N3.wc_sessionAuthenticate.req.ttl ? y6 : N3.wc_sessionAuthenticate.req.ttl, K4 = { authPayload: { type: u3 ?? "caip122", chains: n2, statement: a2, aud: l4, domain: p3, version: "1", nonce: h4, iat: (/* @__PURE__ */ new Date()).toISOString(), exp: d2, nbf: w2, resources: E5 }, requester: { publicKey: C4, metadata: this.client.metadata }, expiryTimestamp: ii(T3) }, fe4 = { eip155: { chains: n2, methods: [.../* @__PURE__ */ new Set(["personal_sign", ...m2])], events: ["chainChanged", "accountsChanged"] } }, q2 = { requiredNamespaces: {}, optionalNamespaces: fe4, relays: [{ protocol: "irn" }], pairingTopic: _2, proposer: { publicKey: C4, metadata: this.client.metadata }, expiryTimestamp: ii(N3.wc_sessionPropose.req.ttl), id: payloadId() }, { done: It4, resolve: Ue4, reject: Se4 } = ei(T3, "Request expired"), te3 = payloadId(), le4 = ci("session_connect", q2.id), Re3 = ci("session_request", te3), pe4 = async ({ error: O5, session: k5 }) => {
        this.events.off(Re3, ve3), O5 ? Se4(O5) : k5 && Ue4({ session: k5 });
      }, ve3 = async (O5) => {
        var k5, Ge3, je4;
        ...
        let he4;
        Te4.length > 0 && (he4 = { topic: se4, acknowledged: true, self: { publicKey: C4, metadata: this.client.metadata }, peer: Q4, controller: Q4.publicKey, expiry: ii(X2), requiredNamespaces: {}, optionalNamespaces: {}, relay: { protocol: "irn" }, pairingTopic: _2, namespaces: ga([...new Set(Te4)], [...new Set(Qe5)]), transportType: r2 }, await this.client.core.relayer.subscribe(se4, { transportType: r2 }), await this.client.session.set(se4, he4), _2 && await this.client.core.pairing.updateMetadata({ topic: _2, metadata: Q4.metadata }), he4 = this.client.session.get(se4)), (k5 = this.client.metadata.redirect) != null && k5.linkMode && (Ge3 = Q4.metadata.redirect) != null && Ge3.linkMode && (je4 = Q4.metadata.redirect) != null && je4.universal && e && (this.client.core.addLinkModeSupportedApp(Q4.metadata.redirect.universal), this.client.session.update(se4, { transportType: Q2.link_mode })), Ue4({ auths: Fe4, session: he4 });
      };
      ...
      try {
        if (i3) {
          ...
          this.client.core.history.set(_2, O5);
          const k5 = await this.client.core.crypto.encode("", O5, { type: ge, encoding: De });
          Ie4 = sa(e, _2, k5);
        } else await Promise.all([this.sendRequest({ topic: _2, method: "wc_sessionAuthenticate", params: K4, expiry: t.expiry, throwOnFailedPublish: true, clientRpcId: te3 }), this.sendRequest({ topic: _2, method: "wc_sessionPropose", params: q2, expiry: N3.wc_sessionPropose.req.ttl, throwOnFailedPublish: true, clientRpcId: q2.id })]);
      } catch (O5) {
        throw this.events.off(le4, pe4), this.events.off(Re3, ve3), O5;
      }
      return await this.setProposal(q2.id, q2), await this.setAuthRequest(te3, { request: x2(I2({}, K4), { verifyContext: {} }), pairingTopic: _2, transportType: r2 }), { uri: Ie4 ?? V4, response: It4 };
      ...
      try {
        ...
        throw i3.setError(rr2.no_internet_connection), y6;
      }
      ...
      const a2 = r2.requester.publicKey, l4 = await this.client.core.crypto.generateKeyPair(), p3 = Fc(a2), h4 = { type: ee, receiverPublicKey: a2, senderPublicKey: l4 }, u3 = [], d2 = [];
      for (const y6 of s) {
        ...
        const { p: E5 } = y6, _2 = Oe(E5.resources), V4 = [Vr(E5.iss)], C4 = dn(E5.iss);
        if (_2) {
          const v3 = If(_2), T3 = Af(_2);
      ...
      let m2;
      if (u3?.length > 0) {
        m2 = { topic: w2, acknowledged: true, self: { publicKey: l4, metadata: this.client.metadata }, peer: { publicKey: a2, metadata: r2.requester.metadata }, controller: a2, expiry: ii(X2), authentication: s, requiredNamespaces: {}, optionalNamespaces: {}, relay: { protocol: "irn" }, pairingTopic: r2.pairingTopic, namespaces: ga([...new Set(u3)], [...new Set(d2)]), transportType: n2 }, i3.addTrace(sr2.subscribing_authenticated_session_topic);
        try {
          await this.client.core.relayer.subscribe(w2, { transportType: n2 });
        } catch (y6) {
          throw i3.setError(rr2.subscribe_authenticated_session_topic_failure), y6;
        }
      ...
      try {
        await this.sendResult({ topic: p3, id: e, result: { cacaos: s, responder: { publicKey: l4, metadata: this.client.metadata } }, encodeOpts: h4, throwOnFailedPublish: true, appLink: this.getAppLinkIfEnabled(r2.requester.metadata, n2) });
      } catch (y6) {
        throw i3.setError(rr2.authenticated_session_approve_publish_failure), y6;
      }
      ...
      await this.sendError({ id: e, topic: a2, error: s, encodeOpts: l4, rpcOpts: N3.wc_sessionAuthenticate.reject, appLink: this.getAppLinkIfEnabled(i3.requester.metadata, i3.transportType) }), await this.client.auth.requests.delete(e, { message: "rejected", code: 0 }), await this.deleteProposal(e);
      ...
      this.client.core.expirer.set(t, ii(N3.wc_sessionPropose.req.ttl)), await this.client.proposal.set(t, e);
      ...
      const { id: e, topic: s, params: i3, verifyContext: r2 } = t, n2 = i3.request.expiryTimestamp || ii(N3.wc_sessionRequest.req.ttl);
      ...
      const { topic: e, method: s, params: i3, expiry: r2, relayRpcId: n2, clientRpcId: a2, throwOnFailedPublish: l4, appLink: p3, tvf: h4 } = t, u3 = formatJsonRpcRequest(s, i3, a2);
      let d2;
      const w2 = !!p3;
      try {
        const E5 = w2 ? De : Qt;
        d2 = await this.client.core.crypto.encode(e, u3, { encoding: E5 });
      } catch (E5) {
        throw await this.cleanup(), this.client.logger.error(`sendRequest() -> core.crypto.encode() for topic ${e} failed`), E5;
      }
      let m2;
      if (mt2.includes(s)) {
        const E5 = zc(JSON.stringify(u3)), _2 = zc(d2);
        m2 = await this.client.core.verify.register({ id: _2, decryptedId: E5 });
      }
      const y6 = N3[s].req;
      if (y6.attestation = m2, r2 && (y6.ttl = r2), n2 && (y6.id = n2), this.client.core.history.set(e, u3), w2) {
        const E5 = sa(p3, e, d2);
        await global.Linking.openURL(E5, this.client.name);
      } else {
        const E5 = N3[s].req;
        r2 && (E5.ttl = r2), n2 && (E5.id = n2), E5.tvf = x2(I2({}, h4), { correlationId: u3.id }), l4 ? (E5.internal = x2(I2({}, E5.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(e, d2, E5)) : this.client.core.relayer.publish(e, d2, E5).catch((_2) => this.client.logger.error(_2));
      }
      return u3.id;
      ...
      try {
        const w2 = h4 ? De : Qt;
        p3 = await this.client.core.crypto.encode(s, l4, x2(I2({}, n2 || {}), { encoding: w2 }));
      } catch (w2) {
      ...
      if (h4) {
        ...
        const w2 = u3.request.method, m2 = N3[w2].res;
        m2.tvf = x2(I2({}, d2), { correlationId: e }), r2 ? (m2.internal = x2(I2({}, m2.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(s, p3, m2)) : this.client.core.relayer.publish(s, p3, m2).catch((y6) => this.client.logger.error(y6));
      }
      ...
      try {
        const d2 = h4 ? De : Qt;
        p3 = await this.client.core.crypto.encode(s, l4, x2(I2({}, r2 || {}), { encoding: d2 }));
      } catch (d2) {
      ...
      if (h4) {
        ...
        const d2 = u3.request.method, w2 = n2 || N3[d2].res;
      ...
      try {
        ...
        this.client.events.listenerCount("session_proposal") === 0 && (console.warn("No listener for session_proposal event"), l4?.setError(Y2.proposal_listener_not_found)), this.isValidConnect(I2({}, s.params));
        const p3 = n2.expiryTimestamp || ii(N3.wc_sessionPropose.req.ttl), h4 = I2({ id: a2, pairingTopic: e, expiryTimestamp: p3, attestation: i3, encryptedId: r2 }, n2);
        ...
        await this.sendError({ id: a2, topic: e, error: l4, rpcOpts: N3.wc_sessionPropose.autoReject }), this.client.logger.error(l4);
      }
      ...
      try {
        ...
        const { relay: r2, controller: n2, expiry: a2, namespaces: l4, sessionProperties: p3, scopedProperties: h4, sessionConfig: u3 } = e.params, d2 = [...this.pendingSessions.values()].find((y6) => y6.sessionTopic === t);
        if (!d2) return this.client.logger.error(`Pending session not found for topic ${t}`);
        const w2 = this.client.proposal.get(d2.proposalId), m2 = x2(I2(I2(I2({ topic: t, relay: r2, expiry: a2, namespaces: l4, acknowledged: true, pairingTopic: d2.pairingTopic, requiredNamespaces: w2.requiredNamespaces, optionalNamespaces: w2.optionalNamespaces, controller: n2.publicKey, self: { publicKey: d2.publicKey, metadata: this.client.metadata }, peer: { publicKey: n2.publicKey, metadata: n2.metadata } }, p3 && { sessionProperties: p3 }), h4 && { scopedProperties: h4 }), u3 && { sessionConfig: u3 }), { transportType: Q2.relay });
      ...
      var e, s, i3;
      const { topic: r2, payload: n2, attestation: a2, encryptedId: l4, transportType: p3 } = t, { id: h4, params: u3 } = n2;
      try {
        await this.isValidRequest(I2({ topic: r2 }, u3));
        const d2 = this.client.session.get(r2), w2 = await this.getVerifyContext({ attestationId: a2, hash: zc(JSON.stringify(formatJsonRpcRequest("wc_sessionRequest", u3, h4))), encryptedId: l4, metadata: d2.peer.metadata, transportType: p3 }), m2 = { id: h4, topic: r2, params: u3, verifyContext: w2 };
      ...
      try {
        const { requester: l4, authPayload: p3, expiryTimestamp: h4 } = i3.params, u3 = await this.getVerifyContext({ attestationId: r2, hash: zc(JSON.stringify(i3)), encryptedId: n2, metadata: l4.metadata, transportType: a2 }), d2 = { requester: l4, pairingTopic: s, id: i3.id, authPayload: p3, verifyContext: u3, expiryTimestamp: h4 };
        await this.setAuthRequest(i3.id, { request: d2, pairingTopic: s, transportType: a2 }), a2 === Q2.link_mode && (e = l4.metadata.redirect) != null && e.universal && this.client.core.addLinkModeSupportedApp(l4.metadata.redirect.universal), this.client.events.emit("session_authenticate", { topic: s, params: i3.params, id: i3.id, verifyContext: u3 });
      } catch (l4) {
        ...
        await this.sendError({ id: i3.id, topic: s, error: l4, encodeOpts: d2, rpcOpts: N3.wc_sessionAuthenticate.autoReject, appLink: u3 });
      }
      ...
      if (!kt(i3) && Ve(i3) !== 0 && this.validateNamespaces(i3, "optionalNamespaces"), kt(r2) || this.validateSessionProps(r2, "sessionProperties"), !kt(n2)) {
        ...
        if (!Object.keys(n2).every((p3) => l4.includes(p3.split(":")[0]))) throw new Error(`Scoped properties must be a subset of required/optional namespaces, received: ${JSON.stringify(n2)}, required/optional namespaces: ${JSON.stringify(l4)}`);
      }
      ...
      var s, i3, r2, n2, a2, l4, p3, h4, u3;
      return !t || e !== Q2.link_mode ? false : ((i3 = (s = this.client.metadata) == null ? void 0 : s.redirect) == null ? void 0 : i3.linkMode) === true && ((n2 = (r2 = this.client.metadata) == null ? void 0 : r2.redirect) == null ? void 0 : n2.universal) !== void 0 && ((l4 = (a2 = this.client.metadata) == null ? void 0 : a2.redirect) == null ? void 0 : l4.universal) !== "" && ((p3 = t?.redirect) == null ? void 0 : p3.universal) !== void 0 && ((h4 = t?.redirect) == null ? void 0 : h4.universal) !== "" && ((u3 = t?.redirect) == null ? void 0 : u3.linkMode) === true && this.client.core.linkModeSupportedApps.includes(t.redirect.universal) && typeof (global == null ? void 0 : global.Linking) < "u";
...
function $3(i3, t, e, s = /* @__PURE__ */ new Map(), n2 = void 0) {
  ...
  if (Array.isArray(i3)) {
    ...
    s.set(i3, r2);
    for (let c4 = 0; c4 < i3.length; c4++) r2[c4] = $3(i3[c4], c4, e, s, n2);
  ...
  if (i3 instanceof Map) {
    ...
    s.set(i3, r2);
    for (const [c4, o2] of i3) r2.set(c4, $3(o2, c4, e, s, n2));
    return r2;
  }
  if (i3 instanceof Set) {
    const r2 = /* @__PURE__ */ new Set();
    s.set(i3, r2);
    for (const c4 of i3) r2.add($3(c4, void 0, e, s, n2));
    return r2;
  }
  ...
  if (i3 instanceof DataView) {
    ...
    return s.set(i3, r2), y5(r2, i3, e, s, n2), r2;
  }
  ...
  if (i3 instanceof Error) {
    ...
    return s.set(i3, r2), r2.message = i3.message, r2.name = i3.name, r2.stack = i3.stack, r2.cause = i3.cause, y5(r2, i3, e, s, n2), r2;
  }
...
function y5(i3, t, e = i3, s, n2) {
  const a2 = [...Object.keys(t), ...at2(t)];
  for (let r2 = 0; r2 < a2.length; r2++) {
    const c4 = a2[r2], o2 = Object.getOwnPropertyDescriptor(i3, c4);
    (o2 == null || o2.writable) && (i3[c4] = $3(t[c4], c4, e, s, n2));
  }
}
function oe(i3) {
  switch (ct3(i3)) {
...
function he3(i3, t) {
  return ce3(i3, (e, s, n2, a2) => {
    ...
    if (typeof i3 == "object") switch (Object.prototype.toString.call(i3)) {
      ...
      case ot2:
      case pt3: {
        const c4 = new i3.constructor(i3?.valueOf());
        return y5(c4, i3), c4;
      }
      case dt3: {
        const c4 = {};
        return y5(c4, i3), c4.length = i3.length, c4[Symbol.iterator] = i3[Symbol.iterator], c4;
      }
      default:
        return;
    }
...
function le3(i3) {
  if (W3(i3)) return i3;
  if (Array.isArray(i3) || K3(i3) || i3 instanceof ArrayBuffer || typeof SharedArrayBuffer < "u" && i3 instanceof SharedArrayBuffer) return i3.slice(0);
...
function fe3(i3, ...t) {
  ...
  for (let a2 = 0; a2 < e.length; a2++) {
    const r2 = e[a2];
    n2 = x3(n2, r2, s, /* @__PURE__ */ new Map());
  }
  return n2;
}
function x3(i3, t, e, s) {
  ...
  for (let a2 = 0; a2 < n2.length; a2++) {
    ...
    const p3 = e(o2, c4, r2, i3, t, s);
    p3 != null ? i3[r2] = p3 : Array.isArray(c4) || ft2(o2) && ft2(c4) ? i3[r2] = x3(o2, c4, e, s) : o2 == null && ue3(c4) ? i3[r2] = x3({}, c4, e, s) : o2 == null && de3(c4) ? i3[r2] = ut3(c4) : (o2 === void 0 || c4 !== void 0) && (i3[r2] = c4);
  }
  return i3;
}
function me3(i3, ...t) {
...
function wt3(i3) {
  ...
  const r2 = {};
  if (!Ve(i3)) return r2;
  for (const [c4, o2] of Object.entries(i3)) {
    const p3 = Pn(c4) ? [c4] : o2.chains, v3 = o2.methods || [], w2 = o2.events || [], P3 = o2.rpcMap || {}, d2 = Yo(c4);
...
function bt2(i3) {
  ...
  for (const [e, s] of Object.entries(i3)) {
    const n2 = s.methods || [], a2 = s.events || [], r2 = s.accounts || [], c4 = Pn(e) ? [e] : s.chains ? s.chains : gt3(s.accounts);
...
var O4 = (i3, t, e) => Ne2(i3, typeof t != "symbol" ? t + "" : t, e);
var De3 = class {
  constructor(t) {
...
var Ue3 = class {
  ...
  async getCapabilities(t) {
    var e, s, n2, a2, r2;
    const c4 = (s = (e = t.request) == null ? void 0 : e.params) == null ? void 0 : s[0], o2 = ((a2 = (n2 = t.request) == null ? void 0 : n2.params) == null ? void 0 : a2[1]) || [];
    if (!c4) throw new Error("Missing address parameter in `wallet_getCapabilities` request");
    const p3 = this.client.session.get(t.topic), v3 = ((r2 = p3?.sessionProperties) == null ? void 0 : r2.capabilities) || {}, w2 = `${c4}${o2.join(",")}`, P3 = v3?.[w2];
    if (P3) return P3;
    let d2;
    try {
      d2 = He3(p3, c4, o2);
...
var E4 = (i3, t, e) => Ge2(i3, typeof t != "symbol" ? t + "" : t, e);
var Je2 = class {
  constructor(t) {
...
var N4 = (i3, t, e) => Qe4(i3, typeof t != "symbol" ? t + "" : t, e);
var Ze3 = class {
  constructor(t) {
...
var D3 = (i3, t, e) => ti2(i3, typeof t != "symbol" ? t + "" : t, e);
var ei3 = class {
  constructor(t) {
    D3(this, "name", "multiversx"), D3(this, "client"), D3(this, "httpProviders"), D3(this, "events"), D3(this, "namespace"), D3(this, "chainId"), this.namespace = t.namespace, this.events = h3("events"), this.client = h3("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
  }
  updateNamespace(t) {
    this.namespace = Object.assign(this.namespace, t);
  }
...
var j2 = (i3, t, e) => ai3(i3, typeof t != "symbol" ? t + "" : t, e);
var ci3 = class {
  constructor(t) {
...
var G3 = class _G {
  ...
  registerEventListeners() {
    ...
    this.client.on("session_ping", (t) => {
      ...
      if (a2.name === "accountsChanged") {
        ...
        const r2 = s.chainId, c4 = s.event.data, o2 = Yo(r2), p3 = V3(r2) !== V3(c4) ? `${o2}:${V3(c4)}` : r2;
  ...
  emitAccountsChangedOnChainChange({ namespace: t, previousChainId: e, newChainId: s }) {
    ...
    try {
      ...
      if (!r2) return;
      const c4 = r2.filter((o2) => o2.includes(`${s}:`)).map(yt2);
      if (!me(c4)) return;
...
*/
//# sourceMappingURL=chunk-TOJWQ5HL.js.map
