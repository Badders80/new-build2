...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-EXHDHV72.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-2MEQQ2RM.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-MLJ2B62G.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-SLG7VYZB.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-USVMG4MM.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-PBZSQXHJ.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-UY6FL2E3.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-XJTQIQJY.js"));
    }
    if (features.pay) {
      featureImportPromises.push(import("./exports-QKB53X4V.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-6D5J3K5R.js"),
      import("./w3m-modal-ORHOS22L.js")
    ]);
  }
};

// node_modules/@reown/appkit/dist/esm/exports/constants.js
var PACKAGE_VERSION = "1.7.16";
...
//# sourceMappingURL=exports-42ZMV5EY.js.map
