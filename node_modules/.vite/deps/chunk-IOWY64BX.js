...
var controller8 = {
  ...
  getAnnouncedConnectorRdns() {
    return state14.connectors.filter((c4) => c4.type === "ANNOUNCED").map((c4) => c4.info?.rdns);
  },
  getConnectorById(id) {
  ...
  getConnector(id, rdns) {
    ...
    return connectorsByNamespace.find((c4) => c4.explorerId === id || c4.info?.rdns === rdns);
  },
...
// node_modules/@walletconnect/ethereum-provider/node_modules/unstorage/dist/shared/unstorage.CoCt7NXC.mjs
...
function Ic(t2) {
  ...
  function j2(g, w2, b2, I2 = U4) {
    ...
    C4 && (w2 = e2.hash(w2));
    const { r: Z2, s: st2 } = D2, W2 = B3(w2), J2 = c4(st2), Be3 = s2(W2 * J2), zt2 = s2(Z2 * J2), vt = a2.BASE.multiplyAndAddUnsafe(z3, Be3, zt2)?.toAffine();
...
var vi2 = class {
  constructor(e2, t2, i3) {
    this.core = e2, this.logger = t2, S2(this, "name", Tt2), S2(this, "keychain"), S2(this, "randomSessionIdentifier", jc()), S2(this, "initialized", false), S2(this, "init", async () => {
      ...
      return Vc({ type: l5, symKey: h4, message: c4, senderPublicKey: d2, encoding: o2?.encoding });
    }), S2(this, "decode", async (s2, n3, o2) => {
      this.isInitialized();
      const a2 = qc(n3, o2);
      if (Fc(a2)) {
        const c4 = Hc(n3, o2?.encoding);
      ...
      try {
        const c4 = this.getSymKey(s2), h4 = Mc({ symKey: c4, encoded: n3, encoding: o2?.encoding });
...
var qn = class extends m {
  constructor(e2, t2) {
    super(e2, t2), this.relayer = e2, this.logger = t2, V2(this, "events", new import_events3.EventEmitter()), V2(this, "name", At2), V2(this, "queue", /* @__PURE__ */ new Map()), V2(this, "publishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), V2(this, "initialPublishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), V2(this, "needsTransportRestart", false), V2(this, "publish", async (i3, s2, n3) => {
      ...
      const a2 = n3?.ttl || je2, c4 = Zc(n3), h4 = n3?.prompt || false, l5 = n3?.tag || 0, d2 = n3?.id || getBigIntRpcId().toString(), g = { topic: i3, message: s2, opts: { ttl: a2, relay: c4, prompt: h4, tag: l5, id: d2, attestation: n3?.attestation, tvf: n3?.tvf } }, _2 = `Failed to publish payload, please try again. id:${d2} tag:${l5}`;
      try {
        const u3 = new Promise(async (b2) => {
          ...
          const I2 = yi(new Promise((D2, j2) => {
            this.rpcPublish({ topic: i3, message: s2, ttl: a2, prompt: h4, tag: l5, id: d2, attestation: n3?.attestation, tvf: n3?.tvf }).then(D2).catch((T) => {
              this.logger.warn(T, T?.message), j2(T);
            });
          }), this.initialPublishTimeout, `Failed initial publish, retrying.... id:${d2} tag:${l5}`);
          try {
            await I2, this.events.removeListener(C2.publish, x2);
          } catch (D2) {
            this.queue.set(d2, Ge2(Ie2({}, g), { attempt: 1 })), this.logger.warn(D2, D2?.message);
          }
        });
...
var Li2 = class {
  constructor(e2, t2) {
    this.core = e2, this.logger = t2, p2(this, "name", Mt2), p2(this, "version", Kt2), p2(this, "events", new import_events3.default()), p2(this, "pairings"), p2(this, "initialized", false), p2(this, "storagePrefix", B), p2(this, "ignoredPayloadTypes", [Ft]), p2(this, "registeredMethods", []), p2(this, "init", async () => {
      ...
      this.isInitialized();
      const s2 = jc(), n3 = await this.core.crypto.setSymKey(s2), o2 = Ei(import_time2.FIVE_MINUTES), a2 = { protocol: xt2 }, c4 = { topic: n3, expiry: o2, relay: a2, active: false, methods: i3?.methods }, h4 = Wc({ protocol: this.core.protocol, version: this.core.version, topic: n3, symKey: s2, relay: a2, expiryTimestamp: o2, methods: i3?.methods });
      return this.events.emit(re2.create, c4), this.core.expirer.set(n3, o2), await this.pairings.set(n3, c4), await this.core.relayer.subscribe(n3, { transportType: i3?.transportType }), { topic: n3, uri: h4 };
...
var Ui2 = class extends M {
  constructor(e2, t2, i3) {
    super(e2, t2, i3), this.core = e2, this.logger = t2, this.store = i3, w(this, "name", Wt2), w(this, "abortController"), w(this, "isDevEnv"), w(this, "verifyUrlV3", Yt2), w(this, "storagePrefix", B), w(this, "version", Le), w(this, "publicKey"), w(this, "fetchPromise"), w(this, "init", async () => {
      ...
      if (!o2) return;
      const c4 = this.getVerifyUrl(s2?.verifyUrl);
...
var Te = class _Te extends h3 {
  constructor(e2) {
    ...
    }), this.logger = E(n3, this.name), this.heartbeat = new i(), this.crypto = new vi2(this, this.logger, e2?.keychain), this.history = new ki2(this, this.logger), this.expirer = new ji2(this, this.logger), this.storage = e2 != null && e2.storage ? e2.storage : new h2(qi2(qi2({}, It), e2?.storageOptions)), this.relayer = new Si({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new Li2(this, this.logger), this.verify = new Ui2(this, this.logger, this.storage), this.echoClient = new Mi2(this.projectId || "", this.logger), this.linkModeSupportedApps = [], this.eventClient = new Bi2(this, this.logger, e2?.telemetryEnabled), this.setGlobalCore(this);
  }
...
*/
//# sourceMappingURL=chunk-IOWY64BX.js.map
